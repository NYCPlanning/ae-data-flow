...
BEGIN;
	...
	SAVEPOINT structure_non_spatial_source;

	CREATE TABLE project_source_point (
		m_agency char(3),
		proj_id text,
		geom geometry(point, 2263)
	);

	CREATE TABLE project_source_multi_polygon (
		m_agency char(3),
		proj_id text,
...
BEGIN;
	...
	CREATE TABLE project (
		...
		li_ft_point geometry(point, 2263),
		li_ft_multi_polygon geometry(multipolygon, 2263),
		mercator_point geometry(point, 3857),
		mercator_multi_polygon geometry(multipolygon, 3857)
	);
